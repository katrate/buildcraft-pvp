...
// ------------------------------------------------------------
define({
  id: 'fire_bolt', name: 'Fire Bolt', description: 'Hurl a bolt of fire dealing heavy damage.',
  kind: 'power', powerKind: 'active', slot: 'active1', price: 1000, rarity: 'common',
  uses: 3, baseDamage: 1.3, flatDamage: 2, targetRule: 'enemy',
  damageType: 'fire', aiPriority: 8,
});
define({
  id: 'shield', name: 'Shield', description: 'Gain a shield that absorbs 25 damage.',
  kind: 'power', powerKind: 'active', slot: 'active1', price: 1000, rarity: 'common',
  uses: 2, targetRule: 'self',
  selfEffects: [{ kind: 'shield', amount: 25, duration: 0 }], aiPriority: 4,
});
define({
  id: 'poison', name: 'Poison', description: 'Poison the enemy: 6 damage per turn for 3 turns.',
  kind: 'power', powerKind: 'active', slot: 'active1', price: 1000, rarity: 'common',
  uses: 2, flatDamage: 2, targetRule: 'enemy', damageType: 'poison',
...
define({
  id: 'heal', name: 'Heal', description: 'Restore 30 HP to an ally (or yourself).',
  kind: 'power', powerKind: 'active', slot: 'active1', price: 1500, rarity: 'uncommon',
  uses: 2, healAmount: 30, targetRule: 'ally', aiPriority: 9,
});
define({
  id: 'thunder_bolt', name: 'Thunder Bolt', description: 'Deal moderate damage and stun the target for 1 turn.',
  kind: 'power', powerKind: 'active', slot: 'active1', price: 2000, rarity: 'rare',
  uses: 2, baseDamage: 1.0, targetRule: 'enemy', damageType: 'lightning',
  effects: [{ kind: 'stun', amount: 1, duration: 1 }], aiPriority: 7,
});
define({
  id: 'fireball', name: 'Fireball', description: 'Blast ALL enemies for moderate fire damage.',
  kind: 'power', powerKind: 'active', slot: 'active1', price: 2000, rarity: 'rare',
  uses: 1, baseDamage: 0.9, targetRule: 'all-enemies', damageType: 'fire', aiPriority: 8,
});
define({
...
define({
  id: 'team_heal', name: 'Mass Mend', description: 'Heal all allies for 15 HP.',
  kind: 'power', powerKind: 'active', slot: 'active1', price: 2000, rarity: 'rare',
  uses: 2, healAmount: 15, targetRule: 'all-allies', aiPriority: 8,
});
define({
  id: 'vampiric_strike', name: 'Vampiric Strike', description: 'Deal damage and heal for 50% of the damage dealt.',
  kind: 'power', powerKind: 'active', slot: 'active1', price: 1500, rarity: 'uncommon',
  uses: 3, baseDamage: 1.1, targetRule: 'enemy',
...
// ------------------------------------------------------------
define({
  id: 'counter', name: 'Counter', description: 'Retaliate for 8 damage whenever you are attacked.',
...
define({
  id: 'regeneration', name: 'Regeneration', description: 'Regenerate 8 HP at the start of each of your turns.',
  kind: 'power', powerKind: 'passive', slot: 'passive1', price: 1500, rarity: 'uncommon',
  targetRule: 'none', effects: [{ kind: 'regen', amount: 8, duration: 0 }],
});
define({
...
define({
  id: 'thorns', name: 'Thorns', description: 'Attackers take 5 damage when they hit you.',
  kind: 'power', powerKind: 'passive', slot: 'passive1', price: 1500, rarity: 'uncommon',
  targetRule: 'none', effects: [{ kind: 'thorns', amount: 5, duration: 0 }],
});
define({
...
// ------------------------------------------------------------
define({
  id: 'inferno', name: 'Inferno', description: 'Deal massive fire damage to ALL enemies.',
  kind: 'power', powerKind: 'ultimate', slot: 'ultimate', price: 2500, rarity: 'epic',
  baseDamage: 2.5, targetRule: 'all-enemies', damageType: 'fire', aiPriority: 10,
});
define({
...
define({
  id: 'mass_renewal', name: 'Mass Renewal', description: 'Heal ALL allies for 30 HP.',
  kind: 'power', powerKind: 'ultimate', slot: 'ultimate', price: 2500, rarity: 'epic',
  healAmount: 30, targetRule: 'all-allies', aiPriority: 9,
});
define({
